...
public abstract class BaseMultiDAO<T, Q extends PageQuery>{
    ...
    public void remove(Q q, String routerId) {
        DeleteResult deleteResult = mongoTemplate.remove(buildQueryWithoutPage(q), getDomainClass(), getCollectionName(routerId));
//        logger.info("Delete Count: "+deleteResult.getDeletedCount());
    }
